...
<body>
	...
	<div class="main">
		<form:form action="updateproductinfo" modelAttribute="existingProductInfo" id="registrationForm">
		Id:<form:input path="id" readonly="true" /> <br>
		Name: <form:input path="name" type="text" required="required"/><br>
		Type: <form:input path="type" type="text" required="required"/><br>
		Cost: <form:input path="cost" id="cost" required="required"/><br>
		Discount:<form:input path="discount" type="number" required="required"/>
